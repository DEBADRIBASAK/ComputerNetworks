...
END
{
    print STDERR "INFO: cleanup up after tests\n";
...
sub backup_restart_test()
{
    ...
    print_msg("INFO: Killing the backup");
    ...
    print_msg("INFO: Killing the primary");
    ...
    print_msg("INFO: restart backup server");
    $NS2->Spawn ();
...
my $result = backup_restart_test ();
show_result($result, "Backup Restart Test");
